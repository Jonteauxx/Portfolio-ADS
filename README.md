...
#### Selecting a Model
Voor het trainen heb ik niet specifiek een model gekozen, maar meer de [code](/src/RL-test2.py) aangepast naar mijn wensen. De code had al een [Environment (Class Area)](/src/RL-test2.py#L35-L48) en een [Agent (Class Container)]() die ik heb aangepast. 
#### Configuring a Model
#### Training a Model
#### Evaluating a Model
